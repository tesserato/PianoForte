...
const static std::vector<float> G1F = { 2.00,3.01,4.01,5.02,7.03,9.07,10.09,12.13,16.34,18.47,23.97,43.46,44.6 }; // 6
...
const static std::vector<float> G2F = { 2.00,3.01,4.01,6.01,9.04,11.09,13.13,14.15,14.19,15.19,20.47,22.57,23.69 }; // 13
